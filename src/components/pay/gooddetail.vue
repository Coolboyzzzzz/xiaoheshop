  ...
  <div class="goosItem">
    <div style="border-bottom:1px solid rgb(220,220,220);padding-left:30px;">
      <img
        ...
        src="https://img.alicdn.com/tfs/TB18DwDbcLJ8KJjy0FnXXcFDpXa-126-36.png"
      > 每满100减50，可选任意图书
    </div>
    <el-row :gutter="20">
      <el-col :span="12">
      ...
      <el-col :span="3">
        <div class="grid-content">
          <span class="forward">￥{{book.bookprice}}</span>
          <div class="current">￥{{discountPrice}}</div>
        </div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content">{{book.book_count}}</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content">
          <span style="color: #f40;font-weight: 700;">￥{{total}}</span>
        </div>
      </el-col>
    </el-row>
  </div>
